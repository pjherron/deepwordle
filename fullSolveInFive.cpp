...
int main() {
	...
	//using only remaining possibles as of feb 12 2022
        vector<string> solutionText = readWordFile("wordlists/answers/possibles.txt");
	...
	//using the full csw19_l5.txt as the guess list
        //vector<string> guess = readWordFile("csw19_l5.txt");
        vector<string> guess = readWordFile("wordlists/answers/possibles.txt"); 
        //vector<string> guess = readWordFile("wordlists/guesses/curatedguesses.txt");
